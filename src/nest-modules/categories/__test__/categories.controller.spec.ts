...
import { CreateCategoryOutput } from 'src/core/category/application/create-category.usecase';
import {
  UpdateCategoryInput,
  UpdateCategoryOutput,
} from 'src/core/category/application/update-category.usecase';
import { GetCategoryOutput } from 'src/core/category/application/get-category.usecase';
